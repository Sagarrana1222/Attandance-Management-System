...
```
$  git clone https://github.com/Mayur-Tiwari/django-student-attendance-system.git
```
...
_For Staff_
Create your own staff via DataBase.
One is:
Email: shiwaligahlot@gmail.com
Password: Shiwali@123

_For Student_
Create your own student list via DataBase.
One is:
